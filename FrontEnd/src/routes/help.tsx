...
export const DOC_CARDS: DocCardItem[] = [
  {
    ...
    shortDescription: "Learn the basics of navigating the Command Hub and interpreting risk data.",
    icon: "quick_reference_all",
    tags: ["Onboarding", "Navigation", "Risk Assessment", "Basics"],
    targetRoute: "/docs/quick-start",
    content: {
      summary: "Overview of core dashboard navigation, node metrics, and real-time alert streams.",
      steps: [
        "Log in using authorized multi-factor credentials.",
        "Check system status metrics (Nodes, Alerts, System %).",
        "Use the global search bar (Cmd + K) to query entities.",
        "Access live crime intelligence layers via the primary map widget.",
      ],
    },
  },
  {
    id: "doc-002",
    title: "FIR Search Syntax",
    shortDescription: "Advanced search operators for finding specific incident reports.",
    icon: "manage_search",
    tags: ["FIR", "Querying", "Search Operators", "Filters"],
    targetRoute: "/docs/search-syntax",
    content: {
      summary: "Comprehensive query syntax supported across Karnataka State Police FIR registries.",
      operators: {
        EXACT_MATCH: '"IPC Section 302"',
        WILDCARD: "theft_*",
        BOOLEAN: "district:Thrissur AND status:PENDING",
        RANGE: "date:[2026-01-01 TO 2026-08-30]",
      },
      sampleSearch: 'type:"Cybercrime" AND status:"Open" AND location:"Vellore"',
    },
  },
  {
    id: "doc-003",
    title: "Understanding Forecasts",
    shortDescription: "How Zia AutoML predictive analytics models generate risk scores.",
    icon: "timeline",
    tags: ["AI", "Zia AutoML", "Predictive Analytics", "Risk Scores"],
    targetRoute: "/docs/forecasts",
    content: {
      engine: "Zia AutoML Engine v2.4",
      modelInputs:
        "Historical crime density, spatial-temporal clustering, repeat offender nodes, seasonal patterns.",
      outputSchema: {
        riskScore: "0.0 - 1.0 (Normalized Float)",
        confidenceInterval: "95%",
        threatCategory: '["Low", "Medium", "High", "Critical"]',
      },
    },
  },
  {
    ...
    shortDescription: "Using the Neo4j topology graph to identify criminal syndicates.",
    icon: "hub",
    tags: ["Neo4j", "Graph Database", "Topology", "Syndicate Mapping"],
    targetRoute: "/docs/network-analysis",
    content: {
      databaseEngine: "Neo4j v5 Enterprise",
      nodeTypes: ["Person", "Location", "Vehicle", "Organization", "Transaction"],
      relationshipTypes: ["ASSOCIATED_WITH", "TRANSACTED_TO", "OPERATES_IN", "MEMBER_OF"],
      queryLanguage: {
        name: "Cypher",
        query: "MATCH (p:Person)-[r:ASSOCIATED_WITH]->(c:Syndicate) RETURN p, r, c",
      },
    },
  },
  {
    ...
    content: {
      supportUnit: "KSP IT Command Center",
      ...
      clearanceLevels: [
        {
          ...
          desc: "Read-only access to localized incident feeds.",
        },
        {
          level: "Level 2 - Inspector / Investigator",
          desc: "Full case file access & network query permissions.",
        },
        {
          level: "Level 3 - Command Admin",
          desc: "Global model overrides, system configurations, and audit log inspection.",
        },
      ],
