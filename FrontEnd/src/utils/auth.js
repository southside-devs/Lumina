...
// Retrieve role from localStorage or default to SCRB Analyst for analytical purposes
...
export function canViewAnalytics(role) {
  return [ROLES.ANALYST, ROLES.SHO, ROLES.ADMIN].includes(role);
}
