...
export async function getSystemConfig() {
  await delay();
  return { appName: "Lumina", environment: "development", features: { analytics: true, aiInsights: true, reportExport: true }, maintenanceMode: false };
}
export const adminService = { getUsers, getRoles, getAuditLogs, getSystemConfig };
